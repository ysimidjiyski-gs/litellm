...
def get_redis_async_client(
    ...
    **env_overrides,
    ...
    if "startup_nodes" in redis_kwargs:
        ...
        # LIT-5836: a single node's client-side timeout must reset only that node's
        # connections, not tear down the whole cluster client for every concurrent caller.
